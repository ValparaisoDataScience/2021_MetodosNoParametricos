...
**Ejercicio 2.** Borre los bloques de códigos R que se generan automáticamente con cada archivo .Rmd y reemplacelos por 5 nuevos bloques de códigos con el botón verde **+C** que se encuentra en la parte superior del panel de códigos. Ejecute cad uno de los siguientes ejercicios en un bloque de códigos.


**Ejercicio 3.** Simule una muestra aletoria de 100 peces de la especie Salmo salar con promedio 5 Kg y con desviación estandar de 0,8 Kg (use punto para representar el decimal: 0.8). Establesca una semilla de 123 usando la función set.seed()
